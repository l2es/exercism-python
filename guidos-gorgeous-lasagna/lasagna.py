...
def preparation_time_in_minutes(number_of_layers):
    ...
    Function that takes the number of layers
    and returns how long it will take to make the lasagna
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Function that takes the number of layers,
    the elapsed time already spent baking in the oven
    and returns the total time spent making the lasagna.
    """
